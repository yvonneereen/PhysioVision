...
const TRANSLATION_ROWS = [
  ...
  ["We will measure your natural standing position and three comfortable half squats.", "我们将测量您自然站立的姿势和三次舒适的半蹲。", "Kami akan mengukur posisi berdiri semula jadi anda dan tiga cangkung separuh yang selesa.", "உங்கள் இயல்பான நிற்கும் நிலையையும், வசதியான மூன்று அரைக் குந்துதல்களையும் அளவிடுவோம்."],
  ["Cancel", "取消", "Batal", "ரத்துசெய்யவும்"],
  ["Save personal range", "保存个人幅度", "Simpan julat peribadi", "தனிப்பட்ட வரம்பைச் சேமிக்கவும்"],
  ["Hands-free mode asks for microphone permission. The exact approved guidance text may be sent securely to Gemini to generate a clearer, more natural voice. Voice recognition may be processed by your browser provider. If fixed safety rules cannot match an answer, the recognized text may be sent to Gemini for constrained language interpretation. Gemini cannot change the safety wording or decide whether exercise is safe. Use the on-screen buttons to avoid voice generation and recognition.", "免手持模式会请求麦克风权限。经批准的确切指导文字可能会安全地发送给Gemini，以生成更清晰、自然的语音。语音识别可能由您的浏览器服务商处理。如果固定安全规则无法匹配回答，识别出的文字可能会发送给Gemini进行受限的语言解读。Gemini不能更改安全措辞，也不能决定运动是否安全。若要避免语音生成和识别，请使用屏幕按钮。", "Mod bebas tangan meminta kebenaran mikrofon. Teks panduan tepat yang diluluskan mungkin dihantar dengan selamat kepada Gemini untuk menghasilkan suara yang lebih jelas dan semula jadi. Pengecaman suara mungkin diproses oleh penyedia pelayar anda. Jika peraturan keselamatan tetap tidak dapat memadankan jawapan, teks yang dikenal pasti mungkin dihantar kepada Gemini untuk tafsiran bahasa yang terhad. Gemini tidak boleh mengubah kata-kata keselamatan atau menentukan sama ada senaman selamat. Gunakan butang pada skrin untuk mengelakkan penjanaan dan pengecaman suara.", "கைகளைப் பயன்படுத்தாத முறை ஒலிவாங்கி அனுமதியைக் கேட்கும். தெளிவான, இயல்பான குரலை உருவாக்க அங்கீகரிக்கப்பட்ட வழிகாட்டல் உரை பாதுகாப்பாக Gemini-க்கு அனுப்பப்படலாம். குரல் அறிதலை உங்கள் உலாவி வழங்குநர் செயலாக்கலாம். நிலையான பாதுகாப்பு விதிகளால் பதிலைப் பொருத்த முடியாவிட்டால், கட்டுப்படுத்தப்பட்ட மொழி விளக்கத்திற்காக அறியப்பட்ட உரை Gemini-க்கு அனுப்பப்படலாம். Gemini பாதுகாப்புச் சொற்களை மாற்றவோ, உடற்பயிற்சி பாதுகாப்பானதா என்று முடிவு செய்யவோ முடியாது. குரல் உருவாக்கத்தையும் அறிதலையும் தவிர்க்க திரைப் பொத்தான்களைப் பயன்படுத்தவும்."],
  ...
  ["The provider accepted both notification requests. This does not mean the contact answered, and no ambulance was dispatched.", "服务商已接受两项通知请求。这不代表联系人已回应，也没有派出救护车。", "Penyedia menerima kedua-dua permintaan pemberitahuan. Ini tidak bermakna hubungan telah menjawab dan tiada ambulans dihantar.", "இரு அறிவிப்பு கோரிக்கைகளையும் வழங்குநர் ஏற்றார். தொடர்பு நபர் பதிலளித்தார் என்று இதற்கு அர்த்தமில்லை; ஆம்புலன்ஸ் அனுப்பப்படவில்லை."],
  ["Either the call or text request failed. Use Call 995 or another phone if urgent.", "电话或短信请求其中一项失败。紧急时请拨打995或使用其他电话。", "Permintaan panggilan atau mesej teks gagal. Gunakan Hubungi 995 atau telefon lain jika mendesak.", "அழைப்பு அல்லது குறுஞ்செய்தி கோரிக்கையில் ஒன்று தோல்வியடைந்தது. அவசரமெனில் 995-ஐ அல்லது வேறு தொலைபேசியைப் பயன்படுத்தவும்."],
  ["A call and text are being requested. No ambulance has been dispatched.", "正在请求电话和短信通知。尚未派出救护车。", "Panggilan dan mesej teks sedang diminta. Tiada ambulans dihantar.", "அழைப்பும் குறுஞ்செய்தியும் கோரப்படுகின்றன. ஆம்புலன்ஸ் அனுப்பப்படவில்லை."],
  ...
  ["Complete the wellness safety screen first.", "请先完成健康安全筛查。", "Lengkapkan saringan keselamatan kesejahteraan dahulu.", "முதலில் நலவாழ்வு பாதுகாப்புத் திரையிடலை முடிக்கவும்."],
  ["Confirm that you are seeking general wellness exercise and do not have clinician restrictions or concerning symptoms.", "请确认您寻求的是一般健康运动，且没有临床限制或令人担忧的症状。", "Sahkan bahawa anda mencari senaman kesejahteraan umum dan tidak mempunyai sekatan klinisian atau gejala yang membimbangkan.", "நீங்கள் பொது நலவாழ்வு உடற்பயிற்சியை நாடுகிறீர்கள் என்றும், மருத்துவர் கட்டுப்பாடுகளோ கவலைக்குரிய அறிகுறிகளோ இல்லை என்றும் உறுதிசெய்யவும்."],
  ["Complete safety screening", "完成安全筛查", "Lengkapkan saringan keselamatan", "பாதுகாப்புத் திரையிடலை முடிக்கவும்"],
  ["Professional review is recommended.", "建议进行专业评估。", "Semakan profesional disyorkan.", "தொழில்முறை மதிப்பாய்வு பரிந்துரைக்கப்படுகிறது."],
  ["Your screening did not unlock self-guided wellness exercise. Review your answers or connect with a qualified professional.", "您的筛查未解锁自助健康运动。请检查回答或联系合格的专业人员。", "Saringan anda tidak membuka senaman kesejahteraan kendiri. Semak jawapan anda atau hubungi profesional yang berkelayakan.", "உங்கள் திரையிடல் சுய வழிகாட்டல் நலவாழ்வு உடற்பயிற்சியைத் திறக்கவில்லை. பதில்களை மதிப்பாய்வு செய்யவும் அல்லது தகுதியான நிபுணரைத் தொடர்புகொள்ளவும்."],
  ["Review screening", "检查筛查结果", "Semak saringan", "திரையிடலை மதிப்பாய்வு செய்யவும்"],
  ...
  ["Personal range saved — movement guide ready", "个人幅度已保存——动作指导已就绪", "Julat peribadi disimpan — panduan pergerakan sedia", "தனிப்பட்ட வரம்பு சேமிக்கப்பட்டது — இயக்க வழிகாட்டி தயாராக உள்ளது"],
  ["Personal tracking baseline saved — movement guide ready", "个人追踪基准已保存——动作指导已就绪", "Garis asas penjejakan peribadi disimpan — panduan pergerakan sedia", "தனிப்பட்ட கண்காணிப்பு அடிப்படை சேமிக்கப்பட்டது — இயக்க வழிகாட்டி தயாராக உள்ளது"],
  ...
  ["Step 3 · Review", "第3步 · 检查", "Langkah 3 · Semak", "படி 3 · மதிப்பாய்வு"],
  ["Your personal range is ready", "您的个人幅度已准备好", "Julat peribadi anda sedia", "உங்கள் தனிப்பட்ட வரம்பு தயாராக உள்ளது"],
  ["Your personal tracking baseline is ready", "您的个人追踪基准已准备好", "Garis asas penjejakan peribadi anda sedia", "உங்கள் தனிப்பட்ட கண்காணிப்பு அடிப்படை தயாராக உள்ளது"],
  ["This adjusts recognition around your movement. Safety limits are not relaxed.", "这会根据您的动作调整识别方式，但不会放宽安全限制。", "Ini melaraskan pengecaman mengikut pergerakan anda. Had keselamatan tidak dilonggarkan.", "இது உங்கள் இயக்கத்திற்கேற்ப அறிதலைச் சரிசெய்கிறது. பாதுகாப்பு வரம்புகள் தளர்த்தப்படாது."],
  ["Save tracking baseline", "保存追踪基准", "Simpan garis asas penjejakan", "கண்காணிப்பு அடிப்படையைச் சேமிக்கவும்"],
  ...
  ["Personal movement setup complete. Review and save your range.", "个人动作设置已完成。请检查并保存您的幅度。", "Persediaan pergerakan peribadi selesai. Semak dan simpan julat anda.", "தனிப்பட்ட இயக்க அமைப்பு முடிந்தது. உங்கள் வரம்பை மதிப்பாய்வு செய்து சேமிக்கவும்."],
  ...
  ["Professional review is recommended before self-guided exercise", "进行自助运动前建议接受专业评估", "Semakan profesional disyorkan sebelum senaman kendiri", "சுய வழிகாட்டல் உடற்பயிற்சிக்கு முன் தொழில்முறை மதிப்பாய்வு பரிந்துரைக்கப்படுகிறது"],
  ["A general wellness plan was not created from your screening answers", "根据您的筛查回答，未能制定一般健康计划", "Pelan kesejahteraan umum tidak dicipta daripada jawapan saringan anda", "உங்கள் திரையிடல் பதில்களிலிருந்து பொது நலவாழ்வுத் திட்டம் உருவாக்கப்படவில்லை"],
  ["Please get professional guidance before starting self-guided exercise.", "开始自助运动前，请先获得专业指导。", "Dapatkan panduan profesional sebelum memulakan senaman kendiri.", "சுய வழிகாட்டல் உடற்பயிற்சியைத் தொடங்குவதற்கு முன் தொழில்முறை வழிகாட்டல் பெறவும்."],
  ["Complete the general wellness safety screen first", "请先完成一般健康安全筛查", "Lengkapkan saringan keselamatan kesejahteraan umum dahulu", "முதலில் பொது நலவாழ்வு பாதுகாப்புத் திரையிடலை முடிக்கவும்"],
  ["Open Create your first plan and complete the wellness questions", "打开“制定您的第一个计划”并完成健康问题", "Buka Cipta pelan pertama anda dan lengkapkan soalan kesejahteraan", "உங்கள் முதல் திட்டத்தை உருவாக்கவும் என்பதைத் திறந்து நலவாழ்வுக் கேள்விகளை முடிக்கவும்"],
  ["Please complete the general wellness safety questions before starting.", "开始前请完成一般健康安全问题。", "Lengkapkan soalan keselamatan kesejahteraan umum sebelum bermula.", "தொடங்குவதற்கு முன் பொது நலவாழ்வு பாதுகாப்புக் கேள்விகளை முடிக்கவும்."],
...
function translateTemplate(text, locale) {
  ...
  const templates = {
    "zh-SG": [
      ...
      [/^(\d+) sets × (\d+) reps(?: · hold (\d+)s)? · (.+) days\/week(?: · prescribed by (.+))?$/, (_, sets, reps, hold, days, clinician) => `${sets}组 × ${reps}次${hold ? ` · 保持${hold}秒` : ""} · ${days === "daily" ? "每天" : `每周${days}天`}${clinician ? ` · 由${clinician}开具` : ""}`],
      ...
      [/^If you do not respond, PhysioVision will request a call and text to (.+)\. It will not call 995\.$/, (_, contact) => `如果您没有回应，PhysioVision将请求给${contact}打电话并发送短信。它不会拨打995。`],
      [/^seconds to answer before (.+) is alerted$/, (_, contact) => `秒内回答，否则将通知${contact}`],
      [/^Call and text requested for (.+)$/, (_, contact) => `已请求给${contact}打电话并发送短信`],
      [/^Only one alert channel reached (.+)$/, (_, contact) => `只有一个警报渠道联系到${contact}`],
      ...
      [/^I can see the required joints, but I have not detected the (.+) position\. Move only as far as is comfortable, then hold still so I can record your knee and hip angles\.$/, (_, phase) => `我可以看到所需关节，但尚未检测到${translateFragment(phase)}姿势。请仅移动到舒适幅度，然后保持不动，以便记录膝盖和髋部角度。`],
    ...
    "ms-SG": [
      ...
      [/^(\d+) sets × (\d+) reps(?: · hold (\d+)s)? · (.+) days\/week(?: · prescribed by (.+))?$/, (_, sets, reps, hold, days, clinician) => `${sets} set × ${reps} ulangan${hold ? ` · tahan ${hold} saat` : ""} · ${days === "daily" ? "setiap hari" : `${days} hari/minggu`}${clinician ? ` · dipreskripsikan oleh ${clinician}` : ""}`],
      ...
      [/^If you do not respond, PhysioVision will request a call and text to (.+)\. It will not call 995\.$/, (_, contact) => `Jika anda tidak memberi respons, PhysioVision akan meminta panggilan dan mesej teks kepada ${contact}. Ia tidak akan menghubungi 995.`],
      [/^seconds to answer before (.+) is alerted$/, (_, contact) => `saat untuk menjawab sebelum ${contact} dimaklumkan`],
      [/^Call and text requested for (.+)$/, (_, contact) => `Panggilan dan mesej teks diminta untuk ${contact}`],
      [/^Only one alert channel reached (.+)$/, (_, contact) => `Hanya satu saluran amaran sampai kepada ${contact}`],
      ...
      [/^I can see the required joints, but I have not detected the (.+) position\. Move only as far as is comfortable, then hold still so I can record your knee and hip angles\.$/, (_, phase) => `Saya dapat melihat sendi yang diperlukan tetapi belum mengesan posisi ${translateFragment(phase)}. Bergerak hanya setakat yang selesa, kemudian jangan bergerak supaya saya boleh merekodkan sudut lutut dan pinggul anda.`],
    ...
    "ta-SG": [
      ...
      [/^(\d+) sets × (\d+) reps(?: · hold (\d+)s)? · (.+) days\/week(?: · prescribed by (.+))?$/, (_, sets, reps, hold, days, clinician) => `${sets} சுற்றுகள் × ${reps} முறை${hold ? ` · ${hold} விநாடிகள் நிலைநிறுத்தவும்` : ""} · ${days === "daily" ? "தினமும்" : `வாரத்தில் ${days} நாட்கள்`}${clinician ? ` · ${clinician} பரிந்துரைத்தது` : ""}`],
      ...
      [/^If you do not respond, PhysioVision will request a call and text to (.+)\. It will not call 995\.$/, (_, contact) => `நீங்கள் பதிலளிக்காவிட்டால், ${contact}-க்கு அழைப்பும் குறுஞ்செய்தியும் அனுப்ப PhysioVision கோரும். இது 995-ஐ அழைக்காது.`],
      [/^seconds to answer before (.+) is alerted$/, (_, contact) => `${contact}-க்கு எச்சரிக்கை அனுப்பப்படும் முன் பதிலளிக்க வேண்டிய விநாடிகள்`],
      [/^Call and text requested for (.+)$/, (_, contact) => `${contact}-க்கு அழைப்பும் குறுஞ்செய்தியும் கோரப்பட்டன`],
      [/^Only one alert channel reached (.+)$/, (_, contact) => `${contact}-ஐ ஒரே ஒரு எச்சரிக்கை வழி மட்டுமே சென்றடைந்தது`],
      ...
      [/^I can see the required joints, but I have not detected the (.+) position\. Move only as far as is comfortable, then hold still so I can record your knee and hip angles\.$/, (_, phase) => `தேவையான மூட்டுகள் தெரிகின்றன; ஆனால் ${translateFragment(phase)} நிலை கண்டறியப்படவில்லை. வசதியான அளவு மட்டும் நகர்ந்து, முழங்கால் மற்றும் இடுப்புக் கோணங்களைப் பதிவுசெய்ய அசையாமல் இருக்கவும்.`],
