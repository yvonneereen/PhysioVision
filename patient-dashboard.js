...
} from "./patient-dashboard-state.js?v=10";
import { saveProfile } from "./personalization.js?v=13";
import { getLocale, translateText } from "./i18n.js?v=30";
import { voiceGuidance } from "./voice-guidance.js?v=39";
import { EXERCISE_MAP } from "./exercises/registry.js?v=59";
